...
Applicant.create(first_name='Robi',last_name='Gáspár',email = '3967sdgdgg@gmail.com',status='new',city='Budapest',school=1)
Applicant.create(first_name='Pavel',last_name='Nowak',email = '329634vv@gmail.com',status='approved',city='Warsaw',school=3)
...
InterviewSlot.create(start='2017-01-30 11:00',end='2017-01-30 12:00',reserved=False,assigned_mentor=2)
